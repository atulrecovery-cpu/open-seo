...
export const buyerLanguageRuns = pgTable(
  "buyer_language_runs",
  {
    id: text("id").primaryKey(),
    projectId: text("project_id")
...
export const buyerLanguageObservations = pgTable(
...
export const buyerLanguageUnknowns = pgTable(
...
export const buyerLanguageContradictions = pgTable(

...
export type RawMetricResult = { kind: "SUCCESS"; artifact: ImmutableEvidenceArtifact; payload: unknown } | { kind: "EVIDENCE_PERSISTENCE_FAILURE"; message: string } | { kind: "HTTP_PROVIDER_FAILURE"; status: number; artifact: { ref: string; sha256: string } } | { kind: "PARSE_FAILURE"; artifact: { ref: string; sha256: string } } | { kind: "PROVIDER_ENVELOPE_FAILURE"; artifact: { ref: string; sha256: string } };
